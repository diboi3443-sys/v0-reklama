    ...
    <header className="sticky top-0 z-40 border-b border-[#D4A853]/5 bg-[#050507]/80 backdrop-blur-2xl">
      <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-2 lg:flex">
          <Link
            href="/image"
            className="rounded-lg px-4 py-2 text-sm font-medium text-[#f0ece4]/70 transition-colors hover:bg-[#D4A853]/10 hover:text-[#f0ece4]"
          >
            Изображения
          </Link>
          <Link
          ...
          <Link
            href="/presets"
            className="flex items-center gap-1.5 rounded-lg px-4 py-2 text-sm font-medium text-[#f0ece4]/70 transition-colors hover:bg-[#D4A853]/10 hover:text-[#f0ece4]"
          >
            Presets
