...
export function ImageContent() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] flex-col lg:flex-row">
      {/* Sidebar */}
      <aside className="w-full border-b border-[#FF6B00]/5 bg-[#08080b] p-5 lg:w-[320px] lg:border-b-0 lg:border-r lg:overflow-y-auto">
        <h3 className="mb-3 text-[11px] font-bold uppercase tracking-[0.15em] text-[#FF6B00]/50">
              ...
              <button
                ...
                className={`flex items-center gap-3 rounded-xl border p-2.5 transition-all ${
                  isActive
                    ...
                    : "border-[#FF6B00]/5 hover:border-[#FF6B00]/15 hover:bg-[#FF6B00]/3"
                }`}
              >
                ...
                {isActive && <Check className="ml-auto h-4 w-4 shrink-0 text-[#FF6B00]" />}
              </button>
            )
          })}
        </div>
        ...
        {/* Aspect Ratio */}
        <h3 className="mb-3 mt-6 text-[11px] font-bold uppercase tracking-[0.15em] text-[#FF6B00]/50">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex flex-1 items-center justify-center p-8">
          <div className="relative h-full w-full max-w-2xl overflow-hidden rounded-2xl border border-[#FF6B00]/10">
            <Image
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="flex flex-col items-center gap-3 text-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-[#f0ece4]/10 bg-[#050507]/50 backdrop-blur-xl">
                  <ImageIcon className="h-8 w-8 text-[#FF6B00]/50" />
                </div>
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#FF6B00]/5 bg-[#08080b]/80 p-5 backdrop-blur-2xl">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium transition-all ${
                    enhance
                      ...
                      : "border border-[#FF6B00]/5 bg-[#FF6B00]/3 text-muted-foreground hover:text-foreground"
                  }`}
                >
                  <Wand2 className="h-3.5 w-3.5" />
                  {t("imagePage.enhance")}
                </button>
                <button className="flex items-center gap-1.5 rounded-lg border border-[#FF6B00]/5 bg-[#FF6B00]/3 px-3 py-1.5 text-xs font-medium text-muted-foreground transition-all hover:border-[#FF6B00]/15 hover:text-foreground">
