      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
        {plans.map((plan) => {
          ...
          return (
            ...
            >
              {isGold && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-[#D4A853] to-[#B8922F] px-4 py-1 text-[10px] font-bold uppercase tracking-wider text-[#050507]">
                  {t("pricingPage.mostPopular")}
                </div>
              )}
              {isCyan && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-[#00D4FF] to-[#00B0D4] px-4 py-1 text-[10px] font-bold uppercase tracking-wider text-[#050507]">
              ...
              <Link
                href="/auth/sign-in"
                className={`mt-6 rounded-xl py-3 text-center text-sm font-semibold transition-all ${
                  plan.key === "free"
